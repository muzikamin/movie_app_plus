                    ...
                    {searchData.map((data) => (
                      <Con key={data.id}>
                        {data.poster_path ? (
                          ...
                          <Link to={`/detail/${data.id}`}>
                            <img
                              src="https://media.istockphoto.com/id/1216251206/ko/%EB%B2%A1%ED%84%B0/%EC%82%AC%EC%9A%A9%ED%95%A0-%EC%88%98-%EC%9E%88%EB%8A%94-%EC%9D%B4%EB%AF%B8%EC%A7%80-%EC%97%86%EC%9D%8C-%EC%95%84%EC%9D%B4%EC%BD%98.jpg?s=170667a&w=0&k=20&c=4oSjH5ISBPZbUQ0JFdkkag7FL4Hy60JnAxOugt5g29g="
                              alt="no image"
                            />
                            <p>{data.title}</p>
                          </Link>
